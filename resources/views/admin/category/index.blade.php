...
<div class="flex-1 overflow-y-auto p-6 custom-scrollbar">
    ...
    <x-admin.category-add />
    <x-admin.category-edit />
        ...
        <table class="w-full text-left border-collapse">
            <thead class="bg-gray-100 border-b border-gray-200 text-center">
                <tr>
                    ...
                    <th class="p-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Tên danh mục</th>
            ...
            <tbody class="divide-y divide-gray-100 text-center" x-data="{}">
                ...
                <tr class="group hover:bg-blue-50 transition border-b transition-colors duration-300">
                    ...
                    <td class="p-4">
                        <p class="font-medium text-gray-900 group-hover:text-blue-600 transition">{{ $category->name }}</p>
                    </td>
                    ...
                    <td class="p-4 flex flex-row justify-center gap-2">
                        <button @click="$dispatch('open-edit-modal', @js($category))" class=" text-gray-400 hover:text-black p-2 transition"><i class="fas fa-edit fa-lg"></i></button>
