...
<head>
    ...
    <title>Tạo Phiếu Nhập - Admin Store</title>
    ...
    <div class="flex h-screen overflow-hidden bg-gray-50">
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 text-white transition-transform duration-300 transform -translate-x-full md:translate-x-0 md:static md:inset-0 flex flex-col">
            ...
            <nav class="flex-1 overflow-y-auto py-4 no-scrollbar">
                ...
                <a href="/Admin/ImportProduct.html" class="flex items-center px-6 py-3 bg-slate-800 border-r-4 border-blue-500 text-blue-400 transition-all hover:text-white group">
        ...
        <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
            <header class="h-16 bg-white border-b flex items-center justify-between px-4 md:px-6 shadow-sm z-10 shrink-0">
                <div class="flex items-center gap-2">
                    <h1 class="text-lg font-bold text-gray-800">Tạo phiếu nhập kho</h1>
                    <span class="px-2 py-0.5 rounded text-xs font-mono bg-gray-100 text-gray-500 border">#PNK-Auto</span>
                </div>
                <div class="flex items-center gap-3">
                    <div class="text-right hidden sm:block">
                        <p class="text-sm font-medium text-gray-700">Kho Chính (Hà Nội)</p>
                        <p class="text-xs text-gray-500">NV: Admin User</p>
                    </div>
                </div>
            </header>
