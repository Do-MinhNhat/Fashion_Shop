            ...
            <tbody class="divide-y divide-gray-100" x-data="{}">
                ...
                <tr class="group hover:bg-blue-50 transition border-b transition-colors duration-300">
                    ...
                    <td class="p-4 flex justify-end gap-2">
                        <form action="{{ route('admin.color.restore', $color) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('PUT')
                        ...
                        <form action="{{ route('admin.color.forceDelete', $color) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
