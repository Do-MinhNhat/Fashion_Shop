...
<div x-data="{ open: false }"
    ...
    x-on:keydown.escape.window="open = false" {{-- Đóng khi nhấn ESC --}}
    ...
    <template x-teleport="body">
        <div x-show="open" class="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            ...
            <div x-show="open"
                ...
                <div class="overflow-y-auto flex-col w-full">
                    <button @click="open = false" class="absolute top-4 right-4 text-gray-500 hover:text-black">&times;</button>
