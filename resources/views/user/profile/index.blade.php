        ...
        <div class="max-w-6xl mx-auto py-10 px-4 flex flex-col md:flex-row gap-8">
            ...
            <aside class="w-full md:w-64 bg-white p-6 shadow-sm h-fit">
                <div class="flex items-center gap-3 mb-8 pb-8 border-b border-gray-100">
                    <div class="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center text-xl font-serif">A</div>
                    <div>
                ...
                <nav class="space-y-2">
                    <a href="/Client/Profile/Profile.html" class="block px-4 py-2 bg-black text-white rounded text-sm font-medium">Thông tin tài khoản</a>
                    <a href="/Client/Order/Order.html" class="block px-4 py-2 hover:bg-gray-100 text-gray-600 rounded text-sm transition">Lịch sử đơn hàng</a>
                    <a href="/Client/Address/Address.html" class="block px-4 py-2 hover:bg-gray-100 text-gray-600 rounded text-sm transition">Sổ địa chỉ</a>
                    <a href="/Auth/Login.html" class="block px-4 py-2 text-red-500 hover:bg-red-50 rounded text-sm transition mt-4">Đăng xuất</a>
                </nav>
            </aside>
