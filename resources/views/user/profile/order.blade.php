    ...
    <div class="bg-gray-50  text-gray-800">
        <div class="max-w-6xl mx-auto py-10 px-4 flex flex-col md:flex-row gap-8">
            <aside class="w-full md:w-64 bg-white p-6 shadow-sm h-fit">
                ...
                <nav class="space-y-2">
                    <a href="/Client/Profile/Profile.html" class="block px-4 py-2 hover:bg-gray-100 text-gray-600 rounded text-sm font-medium">Thông tin tài khoản</a>
                    <a href="/Client/Order/Order.html" class="block px-4 py-2 bg-black text-white rounded text-sm transition">Lịch sử đơn hàng</a>
                    ...
                    <a href="/Auth/Login.html" class="block px-4 py-2 hover:bg-red-50 text-red-500 rounded text-sm transition mt-4">Đăng xuất</a>
                </nav>
            </aside>
