    ...
    <body class="bg-white  text-gray-800">
        <div class="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
            <div class="p-8 lg:p-20 order-2 lg:order-1">
                <a href="/Client/index.html" class="text-2xl  font-bold tracking-widest uppercase mb-10 block">CDHN.</a>
            ...
            <div class="bg-gray-50 p-8 lg:p-20 order-1 lg:order-2">
                ...
                <div class="space-y-6 mb-8">
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1">
                            <h4 class=" font-bold">Silk Elegance Dress</h4>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex-1">
                            <h4 class=" font-bold">Velvet Blazer</h4>
